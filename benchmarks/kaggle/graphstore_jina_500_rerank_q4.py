"""Kaggle: GraphStore + Jina v5 Nano + Jina v3 GGUF Reranker Q4 on LongMemEval-S (500 records)
...
print("Downloading Jina v3 GGUF Reranker (Q4)...")
gguf_path = hf_hub_download("jinaai/jina-reranker-v3-GGUF", "jina-reranker-v3-Q4_K_M.gguf", local_dir="/kaggle/working/jina-reranker")
projector_path = hf_hub_download("jinaai/jina-reranker-v3-GGUF", "projector.safetensors", local_dir="/kaggle/working/jina-reranker")
...
sys.argv = ["bench",
    ...
    "--retrieval-strategy", "full_rerank",
    "--gpu",
    "--gpu-mem-limit-gb", "12",
    "--embed-batch-size", "256",
    "--out-dir", "/kaggle/working/results",
    "--run-tag", "graphstore-jina-500-rerank-q4",
]
